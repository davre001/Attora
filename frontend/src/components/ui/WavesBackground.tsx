...
const COLORS_DATA = new Float32Array([
  0.012, 0.110, 0.149, // #031C26
...
export function WavesBackground({ opacity = 0.10, className = '' }: WavesBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      // Uniforms as prescribed in the specification:
      gl.uniform3fv(uColorsLoc, COLORS_DATA);
  ...
  return (
    <div
      className={`waves-background-container ${className}`}
      style={{
        position: 'fixed',
        inset: 0,
        width: '100vw',
