...
const defaultDescription = (
  <>
    Your RWA stays in a confidential vault on Ethereum. Creditcoin never sees the
    amount — only an{" "}
    <span className="font-medium tracking-tight">Attestcoin proof</span> that the
    collateral is locked.
    <span className="hidden sm:inline">
      {" "}
      Borrow by tier, not by inventory.
    </span>
  </>
);
  ...
  (
    {
      ...
      srTitle = "Attora",
      title = "Hide the size.",
      subtitle = "Prove the lock. Borrow.",
