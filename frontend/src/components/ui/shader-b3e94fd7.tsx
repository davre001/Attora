...
const UNIFORMS = {
  // 21st.dev theme ramp: near-black base → deep navy → blue #3A81F6 → light #91C5FF
  colors: [[0.035,0.037,0.047],[0.086,0.133,0.247],[0.227,0.506,0.965],[0.569,0.773,1.0],[0.569,0.773,1.0],[0.569,0.773,1.0],[0.569,0.773,1.0],[0.569,0.773,1.0]] as [number, number, number][],
  colorCount: 4,
  scale: 2.000,
  intensity: 0.540,
  paramA: 0.470,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Const arrow (not a hoisted function declaration) so the narrowed,
    // non-null types of `canvas`/`gl` above carry into this closure.
